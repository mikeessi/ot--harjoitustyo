...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_maukkaasti_ei_vie_saldoa_negatiiviseksi(self):
        ...
        self.kortti.syo_edullisesti()
        self.kortti.syo_maukkaasti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 3.5 euroa")

    def test_negatiivisen_arvon_lataus_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-100)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_kortilla_voi_ostaa_edullisen_kun_rahaa_juuri_sopivasti(self):
        for i in range(4):
            self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_kortilla_voi_ostaa_maukkaan_kun_rahaa_juuri_sopivasti(self):
